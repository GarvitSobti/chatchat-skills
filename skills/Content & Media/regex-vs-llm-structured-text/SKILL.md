...
requires: []
examples:
  - "Should I use regex or an LLM to parse this quiz text into JSON? Propose a hybrid approach."
  - "Design a regex-first parser and an LLM fallback for these invoices; include a confidence scoring plan."
---
